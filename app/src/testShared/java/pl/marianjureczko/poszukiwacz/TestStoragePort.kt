...
class TestStoragePort(context: Context) : StoragePort(context) {
    ...
    var newPhotoFile: String = runCatching {
        "${context.filesDir.absolutePath}/${someString()}"
    }.getOrElse {
        "${System.getProperty("java.io.tmpdir")}/${someString()}"
    }
