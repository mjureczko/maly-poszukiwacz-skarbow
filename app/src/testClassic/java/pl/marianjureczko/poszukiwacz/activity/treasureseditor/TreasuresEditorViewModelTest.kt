...
internal class TreasuresEditorViewModelTest {
    ...
    fun `SHOULD initialize with route loaded from file WHEN route name exists in the state`() {
        //given
//        val model = pl.marianjureczko.poszukiwacz.activity.treasureseditor.TreasuresEditorViewModel(state)
//        val routeName = some<String>()
//        given(state.get<String>(pl.marianjureczko.poszukiwacz.activity.treasureseditor.TreasuresEditorViewModel.ROUTE_NAME))
...
//        then(state).should().set(pl.marianjureczko.poszukiwacz.activity.treasureseditor.TreasuresEditorViewModel.ROUTE_NAME, routeName)
    }
