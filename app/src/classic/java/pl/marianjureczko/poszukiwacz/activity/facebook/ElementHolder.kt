...
//
//    fun setup(element: pl.marianjureczko.poszukiwacz.activity.facebook.n.ElementDescription) {
...
//        }
//        if (element.type == pl.marianjureczko.poszukiwacz.activity.facebook.n.Type.MAP_ROUTE) {
...
//
//    private fun addListener(selected: ImageButton, element: pl.marianjureczko.poszukiwacz.activity.facebook.n.ElementDescription, elementLayout: LinearLayout) {
