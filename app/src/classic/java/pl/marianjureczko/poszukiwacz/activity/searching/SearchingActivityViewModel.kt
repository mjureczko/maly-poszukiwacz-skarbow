...
//
//class SearchingActivityViewModel(private val state: SavedStateHandle) : ViewModel(), DataStorageWrapper,
//    TreasuresStorage, TipResourcesProvider {
//    companion object {
...
//    private var currentCoordinates: pl.marianjureczko.poszukiwacz.activity.treasureselector.Coordinates? = state.get<pl.marianjureczko.poszukiwacz.activity.treasureselector.Coordinates?>(
//        CURRENT_COORDINATES
//    )
...
//    ): pl.marianjureczko.poszukiwacz.activity.treasureselector.SelectTreasureInputData {
//        treasureSelectionInitialized = true
//        return pl.marianjureczko.poszukiwacz.activity.treasureselector.SelectTreasureInputData(
//            treasureCollected,
//            route,
//            treasuresProgress,
//            currentCoordinates,
//            justFoundTreasureDesc
//        )
//    }
//
...
//        location?.let {
//            currentCoordinates =
//                pl.marianjureczko.poszukiwacz.activity.treasureselector.Coordinates(it.latitude, it.longitude)
