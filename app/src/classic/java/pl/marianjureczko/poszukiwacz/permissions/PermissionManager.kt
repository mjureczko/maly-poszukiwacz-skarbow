...
//    private val permissionListener: pl.marianjureczko.poszukiwacz.permissions.PermissionListener,
//    private val dialogs: Dialogs = Dialogs()
//) {
//
//    companion object {
//
//        fun areAllPermissionsGranted(context: Context, permissions: Array<out pl.marianjureczko.poszukiwacz.permissions.PermissionsSpec>): Boolean =
//            permissions.all { p -> isPermissionGranted(context, p) }
//
//        fun isPermissionGranted(context: Context, permissions: pl.marianjureczko.poszukiwacz.permissions.PermissionsSpec): Boolean {
...
//    }
//
//    fun requestAllPermissions(activity: Activity, activityRequirements: pl.marianjureczko.poszukiwacz.permissions.ActivityRequirements) {
...
//     */
//    fun handleRequestPermissionsResult(activity: Activity, activityRequirements: pl.marianjureczko.poszukiwacz.permissions.ActivityRequirements, permissions: Array<out String>, grantResults: IntArray) {
...
//open class Dialogs {
//
//    fun showResumeDialog(activity: Activity, permissionListener: pl.marianjureczko.poszukiwacz.permissions.PermissionListener) {
...
//        }
//
//    open fun showPermissionRationaleDialog(activity: Activity, activityRequirements: pl.marianjureczko.poszukiwacz.permissions.ActivityRequirements, permissionListener: pl.marianjureczko.poszukiwacz.permissions.PermissionListener) {
//        if (!activity.isFinishing) {
//            AlertDialog.Builder(activity)
...
//    }
//
//    open fun showPermissionPermanentDenialDialog(activity: Activity, activityRequirements: pl.marianjureczko.poszukiwacz.permissions.ActivityRequirements, permissionListener: pl.marianjureczko.poszukiwacz.permissions.PermissionListener) {
//        if (!activity.isFinishing) {
